...
public class PlayerController : MonoBehaviour {
	...
	public void AtualizaHUD(){
		...
		if (velocidadeHorizontal < 0)
			...
			hudVelocidadeHorizontal.text = string.Format ("VELOC H.: {0} {1}", velocidadeHorizontal, setaDireita);
	...
	void OnCollisionEnter2D (Collision2D coll){
		...
		case "Montanha":
			Instantiate (explosao, coll.contacts [0].point, Quaternion.identity);
